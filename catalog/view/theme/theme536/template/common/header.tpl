...
<nav id="top" class="clearfix">
	<div class="container">
		<div class="phone hidden-xs hidden-sm">
			<a href="<?php echo $contact; ?>"><i class="fa fa-phone"></i></a> <span class="hidden-xs hidden-sm"><?php echo $telephone; ?></span>
		</div>
		<ul class="soc-icon">
	...
	<div class="container">
		...
		<div class="box-right clearfix">
			<div class="box-right-bottom">
				...
				<div id="top-links" class="nav pull-left">
					<ul class="list-inline">
						<li class="first"><a href="<?php echo $home; ?>"><i class="fa fa-home"></i><span class="hidden-sm"><?php echo $text_home; ?></span></a></li>
			...
			<div class="box-right2">
				...
				<div class="login_btn">
					<?php if ($logged) { ?>
						 <a href="<?php echo $logout; ?>"><i class="fa fa-lock"></i> <?php echo $text_logout; ?></a>
					<?php } else { ?>
						<a href="<?php echo $login; ?>"> <i class="fa fa-unlock"></i> <?php echo $text_login; ?></a>
					<?php } ?>
				</div>
				<?php echo $search; ?>
			</div>
