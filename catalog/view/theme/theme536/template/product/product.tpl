		...
		<div class="related-products">
			<div class="related_heading">
				<div class="navigations">
					<a class="prev" id="rel_prev" href="#"><span><i class="fa fa-chevron-left"></i></span></a>
					<a class="next" id="rel_next" href="#"><span><i class="fa fa-chevron-right"></i></span></a>
				</div>
				<h3 class="product-section_title"><?php echo $text_related; ?></h3>
			</div>
			<div class="related_content">
			<ul class="related-slider" id="carousel">				
